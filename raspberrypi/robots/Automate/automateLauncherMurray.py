...
class AutomateMurray:
    ...
    #---
        index = 0
        access =1
        self.putOnStackCubeSpot(rm,index,access,logicalActionStackHardMade,robot,builderCollector,waterDispenser)
        
        self.putOnStackFirstDepot(gestionDepot,logicalActionStackHardMade,robot,builderCollector,waterDispenser)
    #---
        index = 1
        access =3
        self.putOnStackCubeSpot(rm,index,access,logicalActionStackHardMade,robot,builderCollector,waterDispenser)
