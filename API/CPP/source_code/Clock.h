...
/** class Clock
 *  \brief Utilitaire pour gérer le temps dans vos programme Arduino.
 *
 *  est un outil permettant à vos programme d'utiliser plus simplement la méthode micros() de <Arduino.h>.
...
public:
	...
	/*!
	* Le constructeur de Clock en plus de construire l'objet fait un premier marqueur qui vous permetera d'utiliser Clock::getElapsedTime pour avoir le temps écoulé depuis la création de l'objet.
	*/
