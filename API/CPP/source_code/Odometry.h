...
/**
 * @brief Interface des roues codeuses.
 * 
 * AbstractCodewheel est l'interface pour les roues codeuses. Elle permet de standardiser les objets Codewheel, ce qui rend l'implémentation de nouveau codewheels dans le système d'odométrie instantané.
 * 
 * 
 */
...
public:
	/**
	 * @brief Constructeur de AbstractCodewheel
	 * 
	 * Constructeur de AbstractCodewheel à implémenter.
	 * 
	 */
